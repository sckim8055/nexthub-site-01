...
const CONTENT = {
  ...
  en: {
    ...
    form_valid_company: "Please enter your company name.",
    form_valid_email: "Please enter your business email.",
    form_valid_email_invalid: "Please enter a valid email address.",
    form_valid_service: "Please select a service.",
    form_valid_size: "Please select your office size.",
    form_valid_message: "Please enter your message.",
  ...
  ko: {
    ...
    form_valid_company: "회사명을 입력해 주세요.",
    form_valid_email: "업무 이메일을 입력해 주세요.",
    form_valid_email_invalid: "올바른 이메일 주소를 입력해 주세요.",
    form_valid_service: "서비스를 선택해 주세요.",
    form_valid_size: "오피스 규모를 선택해 주세요.",
    form_valid_message: "문의 내용을 입력해 주세요.",
  ...
  zh: {
    ...
    form_valid_email: "请输入商务邮箱。",
    form_valid_email_invalid: "请输入有效的邮箱地址。",
    form_valid_service: "请选择服务。",
    form_valid_size: "请选择办公室规模。",
    form_valid_message: "请输入留言内容。",
